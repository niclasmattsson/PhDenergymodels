...
total_cap(t)
demand_out(reg, *,t)
report_elec_gen(en_in,type,reg,slice,t)
total_elec_gen(reg,slice,t)
report_elec_use(reg,elecsector,slice,t)
report_lfs(en_in, type,reg,slice)
report_slice_lng(reg,slice)
report_capital_region(en_in, type, reg, t)
report_elec_gen_slice(en_in,type,reg,t,slice)
report_elec_gen_summedslices(en_in,type,reg,t)
report_storage_transfers_2100(storage_tech,reg,slice,slice2)
report_from_storage(t,reg,slice2)
report_to_storage(t,reg,slice)
report_capital_class(class_tech,class,reg,t)
report_elec_solarwind(class_tech,reg,slice,t)
report_elec_class_slice(class_tech,class,reg,slice,t)
potential_generation(en_in,type,reg,slice,t)
curtailment(en_in,type,reg,t,slice)
...
execute_unload "%RESULTSFILE%.gdx" oils report_supply1 report_c report_capital report_engines report_invest report_elec_gen total_elec_gen elec_dem report_elec_use
        ...
        curtailment report_elec_gen_summedslices
